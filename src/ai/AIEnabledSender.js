...
class AIEnabledSender extends WhatsAppSender {
     ...
     */
    setupMessageHandler() {
        this.debugMessage('Setting up message handler with AI response capability...');
        ...
        this.client.on('message', async (message) => {
            ...
            try {
                ...
                // Check if we should respond (not in blocked list, no stop request)
                // This is now handled internally by the AIResponder
